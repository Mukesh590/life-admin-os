...
export function getCategoryColor(category: string): string {
  const map: Record<string, string> = {
    school: 'bg-blue-500/15 text-blue-400 border-blue-500/20',
    ...
    medical: 'bg-rose-500/15 text-rose-400 border-rose-500/20',
    government: 'bg-amber-500/15 text-amber-400 border-amber-500/20',
    other: 'bg-zinc-500/15 text-zinc-500 border-zinc-500/20',
    entertainment: 'bg-purple-500/15 text-purple-400 border-purple-500/20',
    utilities: 'bg-orange-500/15 text-orange-400 border-orange-500/20',
    insurance: 'bg-teal-500/15 text-teal-400 border-teal-500/20',
    software: 'bg-indigo-500/15 text-indigo-400 border-indigo-500/20',
    rent: 'bg-sky-500/15 text-sky-400 border-sky-500/20',
  }
  return map[category?.toLowerCase()] || 'bg-zinc-500/15 text-zinc-500 border-zinc-500/20'
}
